class ContainerCompose < Formula
  ...
  url "https://github.com/stephenlclarke/container-compose/releases/download/0.6.35/container-compose-plugin-release-arm64.tar.gz"
  version "0.6.35"
  sha256 "34062db6901bc776065e7ec6ec46e5a73f7744251d28973fdd7c39104a344a2f"
  license "Apache-2.0"
  ...
  test do
    assert_match "0.6.35", shell_output("#{bin}/container-compose version --short")
