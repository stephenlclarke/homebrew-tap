class ContainerCompose < Formula
  ...
  url "https://github.com/stephenlclarke/container-compose/releases/download/0.6.1/container-compose-plugin-release-arm64.tar.gz"
  version "0.6.1"
  sha256 "81cc0a099b524b1592d460698d83f2fb2d9b5b4450148dc52bd4747fb40994c8"
  license "Apache-2.0"
  ...
  test do
    assert_match "0.6.1", shell_output("#{bin}/container-compose version --short")
