class ContainerCompose < Formula
  ...
  url "https://github.com/stephenlclarke/container-compose/releases/download/0.6.14/container-compose-plugin-release-arm64.tar.gz"
  version "0.6.14"
  sha256 "6ac153d473a707868c3a47dffa5565cc930436d66a30e939aeaa407cb443ec81"
  license "Apache-2.0"
  ...
  test do
    assert_match "0.6.14", shell_output("#{bin}/container-compose version --short")
