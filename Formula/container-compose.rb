class ContainerCompose < Formula
  ...
  url "https://github.com/stephenlclarke/container-compose/releases/download/0.6.9/container-compose-plugin-release-arm64.tar.gz"
  version "0.6.9"
  sha256 "4f25fcda65b571851ff0769d0849e40d60c2ea58d00ad60f21cea3075401e5d0"
  license "Apache-2.0"
  ...
  test do
    assert_match "0.6.9", shell_output("#{bin}/container-compose version --short")
