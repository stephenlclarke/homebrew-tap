class ContainerCompose < Formula
  ...
  url "https://github.com/stephenlclarke/container-compose/releases/download/0.6.27/container-compose-plugin-release-arm64.tar.gz"
  version "0.6.27"
  sha256 "87de6f9354ac7f5362406ba71786e5f8532908bb078dc82c35a73e040ab017d5"
  license "Apache-2.0"
  ...
  test do
    assert_match "0.6.27", shell_output("#{bin}/container-compose version --short")
