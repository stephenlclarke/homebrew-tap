class ContainerCompose < Formula
  ...
  url "https://github.com/stephenlclarke/container-compose/releases/download/0.6.24/container-compose-plugin-release-arm64.tar.gz"
  version "0.6.24"
  sha256 "cda99ec7f19ff03bef9802a8563f6b6664c886a0f40699b2bcf8f8eaf7d75fca"
  license "Apache-2.0"
  ...
  test do
    assert_match "0.6.24", shell_output("#{bin}/container-compose version --short")
