class ContainerCompose < Formula
  ...
  url "https://github.com/stephenlclarke/container-compose/releases/download/0.6.64/container-compose-plugin-release-arm64.tar.gz"
  version "0.6.64"
  sha256 "1c2a3e792070e7fc15ce7583ff8c5521fb2b1ab7574e6494b63aa48b254908a0"
  license "Apache-2.0"
  ...
  test do
    assert_match "0.6.64", shell_output("#{bin}/container-compose version --short")
