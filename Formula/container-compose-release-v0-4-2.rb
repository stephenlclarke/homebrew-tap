class ContainerComposeReleaseV042 < Formula
  desc "Docker Compose style plugin for Apple's container CLI"
  homepage "https://github.com/stephenlclarke/container-compose"
  url "https://github.com/stephenlclarke/container-compose/releases/download/homebrew-release-v0.4.2/container-compose-plugin-release-v0.4.2-release-arm64.tar.gz"
  version "release-v0.4.2-release-cebba64389bb"
  sha256 "75df85d1a4856b76bf37838b10c70ad36749476307728f8c0d9d2db9c07719a4"
  license "Apache-2.0"
  ...
  def caveats
    <<~EOS
      ...
      This formula installs the release-v0.4.2 branch prebuilt package asset:
        container-compose-plugin-release-v0.4.2-release-arm64.tar.gz
    EOS
  end

  test do
    assert_match "0.4.2", shell_output("#{bin}/container-compose version --short")
