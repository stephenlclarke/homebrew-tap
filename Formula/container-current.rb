class ContainerCurrent < Formula
  ...
  url "https://github.com/stephenlclarke/container-compose/releases/download/current/container-current-6964bcdd87c6-arm64.tar.gz"
  version "current.6964bcdd87c6"
  sha256 "3f6758bb8d6a92692f5f0c1cc04d8a6bef40ebef7a23146cd9f0bd5300147a2a"
  license "Apache-2.0"
  ...
  def caveats
    <<~EOS
      This formula installs the current build prebuilt package asset:
        container-current-6964bcdd87c6-arm64.tar.gz
