class ContainerComposeReleaseV041 < Formula
  desc "Docker Compose style plugin for Apple's container CLI"
  homepage "https://github.com/stephenlclarke/container-compose"
  url "https://github.com/stephenlclarke/container-compose/releases/download/homebrew-release-v0.4.1/container-compose-plugin-release-v0.4.1-release-arm64.tar.gz"
  version "release-v0.4.1-release-68d1c7917aae"
  sha256 "84b04eeb7e339a3964f0b2619d4ef1c2cca6e7dc5118f761437182a75b8516af"
  license "Apache-2.0"
  ...
  def caveats
    <<~EOS
      ...
      This formula installs the release-v0.4.1 branch prebuilt package asset:
        container-compose-plugin-release-v0.4.1-release-arm64.tar.gz
    EOS
  end

  test do
    assert_match "0.4.1", shell_output("#{bin}/container-compose version --short")
