class ContainerComposeCurrent < Formula
  ...
  url "https://github.com/stephenlclarke/container-compose/releases/download/current/container-compose-plugin-current-415bed774281-arm64.tar.gz"
  version "current.415bed774281"
  sha256 "e0e17cd8dddeedf86dfbda6abf9e2f451ccb4b7b930f545e53d7f763c064d1a8"
  license "Apache-2.0"
  ...
  def caveats
    <<~EOS
      ...
      This formula installs the current build prebuilt package asset:
        container-compose-plugin-current-415bed774281-arm64.tar.gz
    EOS
  end
