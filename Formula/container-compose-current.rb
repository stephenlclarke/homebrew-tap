class ContainerComposeCurrent < Formula
  ...
  url "https://github.com/stephenlclarke/container-compose/releases/download/current/container-compose-plugin-current-db21f0b4f481-arm64.tar.gz"
  version "current.db21f0b4f481"
  sha256 "c9731dc217e522f7a529ef8357dc7bb3cae42b216690c34c98cd4bd635dfaadf"
  license "Apache-2.0"
  ...
  def caveats
    <<~EOS
      ...
      This formula installs the current build prebuilt package asset:
        container-compose-plugin-current-db21f0b4f481-arm64.tar.gz
    EOS
  end
