class ContainerComposeCurrent < Formula
  ...
  url "https://github.com/stephenlclarke/container-compose/releases/download/current/container-compose-plugin-current-4a2928019593-arm64.tar.gz"
  version "current.1176.4a2928019593"
  sha256 "d14adb35cc020ac0b1b22720b2bddf3248225ac8e306ef2d91c8519350cdc4b8"
  license "Apache-2.0"
  ...
  def caveats
    <<~EOS
      ...
      This formula installs the current build prebuilt package asset:
        container-compose-plugin-current-4a2928019593-arm64.tar.gz
    EOS
  end
