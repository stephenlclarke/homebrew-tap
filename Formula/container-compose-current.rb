class ContainerComposeCurrent < Formula
  ...
  url "https://github.com/stephenlclarke/container-compose/releases/download/current-7a76b0b889c18786090d71638dc3342631491b92/container-compose-plugin-current-7a76b0b889c1-arm64.tar.gz"
  version "current.1264.7a76b0b889c1"
  sha256 "2880163b214973b77c847a457b2f87fda301449e890646ef6dfbb4e803c60e3b"
  license "Apache-2.0"
  ...
  def caveats
    <<~EOS
      ...
      This formula installs the current build prebuilt package asset:
        container-compose-plugin-current-7a76b0b889c1-arm64.tar.gz
    EOS
  end
